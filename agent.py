...
class Agent():
    ...
    def run(self, is_training=True, render=False):
        ...
        env = GameController(rlTraining=True , mode = NORMAL_MODE , move_mode = DISCRETE_STEPS_MODE , clock_tick= 10 , pacman_lives=3 , maze_mode=MAZE1 , pac_pos_mode=NORMAL_PAC_POS)
        ...
        for episode in itertools.count():
            ...
            num_pellets_remaining.append(len(env.pellets.pelletList))
