...
from Environment.run import GameController
from Environment.constants import *
from reward_functions.reward_func_eat_pellets2 import *
...
if __name__ == "__main__":
    ...
    env_render = gym.make("pacman-v0", max_episode_steps = 10_000 , render_mode = "human" , mode = SAFE_MODE , move_mode = DISCRETE_STEPS_MODE, clock_tick = 10 , pacman_lives = 1)
    
    model_load_path = "./models/dqn_baseline_cnn3"   #with max_useless_steps = 1000
    model_path = "./models/dqn_baseline_cnn3_modified3"
    ...
    if not os.path.exists(model_path):  
        ...
        model_final_path = f"{model_load_path}/2000000.zip"
        ...
        time_steps = 400_000
        for i in range (100):
            model.learn(total_timesteps = time_steps , progress_bar=True , reset_num_timesteps = False , tb_log_name = "./cnn/dqn_baseline_cnn3_modified3")
...
#     env = gym.make("pacman-v0", render_mode="human" , mode = SAFE_MODE , move_mode = DISCRETE_STEPS_MODE, clock_tick = 0 , pacman_lives = 1)
