        ...
        self.observation_space = spaces.Dict(
            {
                ...
                "ghosts_position": spaces.Box(
                    low = np.array([[0,0,-2,GHOST_PENALITY],
                                    [0,0,-2,GHOST_PENALITY],
                                    [0,0,-2,GHOST_PENALITY],
                                    [0,0,-2,GHOST_PENALITY]]
                    ), 
                    high = np.array([[GAME_ROWS,GAME_COLS,2,GHOST_REWARD * NUMGHOSTS],
                                    [GAME_ROWS,GAME_COLS,2,GHOST_REWARD * NUMGHOSTS],
                                    [GAME_ROWS,GAME_COLS,2,GHOST_REWARD * NUMGHOSTS],
                                    [GAME_ROWS,GAME_COLS,2,GHOST_REWARD * NUMGHOSTS]]
                    ), 
                    shape = (4,4) , 
...
#     model_path = "./models/simple_DQN_full_maze_map_baseline"
#     log_path = "./logs/fit"
...
#         time_steps = 400_000
#         for i in range (100):
#             model.learn(total_timesteps = time_steps , progress_bar=True , reset_num_timesteps = False , tb_log_name = "simple_DQN_full_maze_map_baseline")
