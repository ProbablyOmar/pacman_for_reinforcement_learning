...
if __name__ == "__main__":
    ...
    env_render = gym.make("pacman-v0", max_episode_steps = 10_000 , render_mode = "human" , mode = NORMAL_MODE , move_mode = DISCRETE_STEPS_MODE, clock_tick = 10 , pacman_lives = 7,  maze_mode = MAZE1 , pac_pos_mode = RANDOM_PAC_POS)
