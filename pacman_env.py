...
if __name__ == "__main__":
    ...
    model_load_path = "./models/dqn_baseline_cnn3_eat_pellets_4"   #with max_useless_steps = 1000
    model_path = "./models/dqn_baseline_cnn3_eat_pellets_from_beg_2"
    ...
    if not os.path.exists(model_path):  
        ...
        policy_kwargs = dict(
            features_extractor_class=CustomCNN_eat_pellets_from_beg_2,
        ...
        time_steps = 400_000
        for i in range (100):
            model.learn(total_timesteps = time_steps , progress_bar=True , reset_num_timesteps = False , tb_log_name = "./cnn/dqn_baseline_cnn3_eat_pellets_from_beg_2")
...
#     env = gym.make("pacman-v0", render_mode="human" , mode = SAFE_MODE , move_mode = DISCRETE_STEPS_MODE, clock_tick = 10 , pacman_lives = 1)
