...
if __name__ == "__main__":
    ...
    model_path = "./models/DQN_MODEL_SAFE_MODE"
    ...
    if not os.path.exists(model_path):  
        ...
        time_steps = 1000000
        for i in range (50):
            model.learn(total_timesteps = time_steps , progress_bar=True , reset_num_timesteps = False , tb_log_name = "./cnn/DQN_MODEL_SAFE_MODE")
